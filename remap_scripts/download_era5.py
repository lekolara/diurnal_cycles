...
def save_monthly_raw_era5(year: int, month: int, variables_to_select, output_base_dir: str = "/scratch/leko/IWP/ERA5_raw"):
    '''
...
for year in range(2018, 2019):
    for month in range(1, 13):
        try:
            save_monthly_raw_era5(year, month, variables_to_select)
