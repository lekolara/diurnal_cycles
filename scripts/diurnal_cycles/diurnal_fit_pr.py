...
# if RELATIVE:
#     OUTPUT_FILE = f"/scratch/leko/IMERG/IMERG_1_deg_diurnal/IMERG_diurnal_fit_utc_relative_new.nc"
# else:
#     OUTPUT_FILE = f"/scratch/leko/IMERG/IMERG_1_deg_diurnal/IMERG_diurnal_fit_utc_new.nc"
...
if RELATIVE:
    OUTPUT_FILE = f"/scratch/leko/ERA5/ERA5_1_deg_diurnal/IMERG_diurnal_fit_utc_relative_new.nc"
else:
    OUTPUT_FILE = f"/scratch/leko/ERA5/ERA5_1_deg_diurnal/IMERG_diurnal_fit_utc_new.nc"
