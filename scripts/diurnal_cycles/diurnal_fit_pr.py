#!/usr/bin/env python3
##############################################################################################################
# Script to fit a harmonic function to the diurnal cycle of precip and calculate the amplitude 
...
def sinfit2d_with_metrics(x, y):
    ...
    y : xarray Dataarray, The y-axis data (precip)    
...
# # IMERG
# INPUT_FILES = ["/scratch/leko/IMERG/IMERG_1_deg_diurnal/IMERG_diurnal_climatology_2018_2023_utc.nc"]
