...
def load_and_process_single_file(filename, varname_out="pr", multiply_era5=False):
    ...
    hours = ds["time"].dt.hour + ds["time"].dt.minute / 60
...
def compute_diurnal_mean(ds, var="pr"):
    ...
    # groupby hour_of_day gives 24 (ERA5) or 48 (IMERG)
...
def build_diurnal_climatology(
    ...
    for month in range(1, 13):
        ...
        for year in range(start_year, end_year + 1):
            ...
            f2 = input_root / yr / alt_pattern.format(year=yr, month=mm)
...
if __name__ == "__main__":
    ...
    build_diurnal_climatology(
        ...
        output_file="/scratch/leko/ERA5/ERA5_1_deg_diurnal/ERA5_diurnal_climatology_2018_2023.nc",
        start_year=2018,
        end_year=2023,
        monthly_pattern="{year}_{month}_era5_diurnal_mean.nc",
        alt_pattern="{year}{month}_era5_diurnal_mean.nc",
    )
    '''
    ...
    build_diurnal_climatology(
        ...
        alt_pattern="{year}{month}_IMERG_diurnal_mean.nc",
    )